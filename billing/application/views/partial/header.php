		...
		<div class="topbar">
			<div class="container">
				...
				<div class="navbar-right" style="margin:0">
					<?php echo anchor(($controller_name == 'profile' ? 'profile' : 'employees').'/change_password/'.$user_info->person_id, $user_info->first_name . ' ' . $user_info->last_name, array('class' => 'modal-dlg', 'data-btn-submit' => 'Submit', 'title' => $this->lang->line('employees_change_password'))); ?>

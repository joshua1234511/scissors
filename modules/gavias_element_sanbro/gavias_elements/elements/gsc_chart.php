         ...
         $fields = array(
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'type'      => 'text',
                  'title'     => t('Chart Icon'),
                  'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="'.base_path().drupal_get_path('theme', 'gavias_sanbro').'/demo-font/index.html'.'">Custom icon</a>'),
               ),
               array(
                  'id'        => 'content',
                  'type'      => 'textarea',

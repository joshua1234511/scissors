...
?>
    ...
    <?php if(isset($customize['font_family_primary'])  && $customize['font_family_primary'] != '---'){ ?>
        ...
        .gva-googlemap .gm-style-iw div .marker .info, .gsc-carousel-content.style-1 .content-box .content-inner .action a
        {
    ...
    <?php if(isset($customize['font_family_second'])  && $customize['font_family_second'] != '---'){ ?>
        h1, h2, h3, h4, h5, h6,
        .h1, .h2, .h3, .h4, .h5, .h6,
        .post-block .post-title a, .portfolio-filter ul.nav-tabs > li > a, .portfolio-carousel-single .content-right .content-inner .title,
        .portfolio-v1 .content-inner .title a, .portfolio-v2 .content-inner .title, .testimonial-node-v1 .testimonial-content .info .right .title a,
        .btn, .btn-white, .btn-theme, .portfolio-filter ul.nav-tabs > li > a, .pricing-table .plan-name .title, .navigation .gva_menu > li > a,
        .widget.gsc-icon-box .highlight_content .title, .widget.gsc-video-box .video-content .video-title, .widget.milestone-block .milestone-number,
        .widget.milestone-block .milestone-text, .gsc-box-color .box-title, .gsc-image-content .action a, .gsc-box-number .title, .gsc-carousel-content.style-2 .content-box .content-inner .title a
        {
    ...
    <?php if(isset($customize['body_bg_image'])  && $customize['body_bg_image']){ ?>
        body{
            background-image:url('<?php echo drupal_get_path('theme', 'gavias_sanbro') .'/images/patterns/'. $customize['body_bg_image']; ?>');
        }
    <?php } ?> 

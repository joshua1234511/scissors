<div id="gavias_customize_form" class="gavias_customize_form">
   ...
   <div class="form-group action">
      ...
      <input type="hidden" id="gva_theme_name" name="theme_name" value="gavias_sanbro" />
   </div>   
         ...
         <div class="panel panel-default">
            ...
            <div id="customize-body" class="panel-collapse collapse" role="tabpanel" >
               <div class="panel-body">
                  ...
                  <div class="form-wrapper">
                  <div class="desc" style="line-height: 16px;"><b>You can upload image for /themes/gavias_sanbro/images/patterns</b></div>
                     <div class="form-group">

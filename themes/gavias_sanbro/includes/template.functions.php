<?php
function gavias_sanbro_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'gavias_sanbro');
  return $base_url . '/' . $theme_path . '/';
}

function gavias_sanbro_preprocess_node(&$variables) {
...
function gavias_sanbro_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function gavias_sanbro_preprocess_breadcrumb(&$variables){
